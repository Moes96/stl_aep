...
int main(int argc, char** argv)
{
  ...
  stats_file << "Stamp, Min, Max, Current closest distance, Mean closest distance, "
                "Current closest distance, Min altitude, Max altitude, Current closest altitude, Mean closest "
                "altitude\n";
  ...
  ros::Subscriber pose_sub = nh.subscribe("/position_drone", 1, &poseCallback);   //   /mavros/local_position/pose
